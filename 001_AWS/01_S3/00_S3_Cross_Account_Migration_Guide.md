...
Example bucket name: niwas-prod-migrated
...
"S3FullAccessForMigration", "Effect": "Allow", "Action": \[
"s3:ListBucket", "s3:GetObject", "s3:PutObject", "s3:DeleteObject" \],
"Resource": \[ "arn:aws:s3:::niwas-prod-migrated",
"arn:aws:s3:::niwas-prod-migrated/\*" \] } \] }
...
{ "Version": "2012-10-17", "Statement": \[ { "Sid":
"AllowMobiculeReadAccess", "Effect": "Allow", "Principal": { "AWS":
"arn:aws:iam::MOBICULE_ACCOUNT_ID:user/s3-migration-user" }, "Action":
\[ "s3:ListBucket", "s3:GetObject" \], "Resource": \[
"arn:aws:s3:::source-bucket-name", "arn:aws:s3:::source-bucket-name/\*"
\] } \] }
