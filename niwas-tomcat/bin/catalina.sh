...
JAVA_OPTS="-server -XX:+UseG1GC -XX:+ExplicitGCInvokesConcurrent -XX:MaxGCPauseMillis=500 -Xms8192M -Xmx8192M -Xlog:gc*,safepoint=info:file=/app/digital/apache-tomcat-9.0.91-Niwas/logs/gc_%p_%t.log:time,uptime:filecount=10 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/app/digital/apache-tomcat-9.0.91-Niwas/heapdumps"
