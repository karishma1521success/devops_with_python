...
JAVA_OPTS="-server -XX:+UseG1GC -XX:+ExplicitGCInvokesConcurrent -XX:MaxGCPauseMillis=500 -Xms2048M -Xmx2048M -Xlog:gc*,safepoint=info:file=/home/gourav/Downloads/Tomcat-10.1.34/apache-tomcat-10.1.34-src-zip/logs/gc_%p_%t.log:time,uptime:filecount=10 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/home/gourav/Downloads/Tomcat-10.1.34/apache-tomcat-10.1.34-src-zip/heapdumps"
